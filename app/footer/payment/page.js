    ...
    return (
        <>
            <div className='p-5 mx-16 leading-relaxed'>
                ...
                <p>
                    Оплата заказа наличными после примерки возможна в пунктах самовывоза и курьерам. Кроме заказов отправленных Почтой России.
                </p>
                <h2>
                    Безналичный расчет
                </h2>
                <p>
                    ...
                    По вопросам оплаты с помощью банковской карты и иным вопросам, связанным с работой сайта, Вы можете обращаться по телефону: 8 (800) 333-37-28.
