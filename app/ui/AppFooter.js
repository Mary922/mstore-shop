...
const AppFooter = () => {
    ...
    return (
        <>
            <footer className="footer bg-neutral w-full px-5 py-4 text-neutral-content grid grid-cols-3 mobile:grid-cols-1 mobile:py-0 mobile:my-0 mobile:px-0 mobile:gap-1">
                <nav className='text-neutral-content mobile:px-5'>
                ...
                <nav className='mobile:px-5'>
                    ...
                    <div className='text-neutral-content'>Телефон: <span
                        className='text-neutral-content text-lg mobile:text-sm'>+{phone}</span></div>
                    <div className='text-neutral-content flex flex-row items-center gap-2'>
                        <span>Оплата картами:</span> {renderImages()} </div>
                </nav>
            </footer>

            <footer className="navbar bg-neutral text-neutral-content border-base-300 border-t w-full mobile:px-0">
